...
public class RankSingleRatio {
    ...
    public RankSingleRatio() {
    }

    @Override
    public String toString() {
        return "RankSingleRatio{" +
                "first=" + first +
                ", second=" + second +
                ", third=" + third +
                ", fourth=" + fourth +
    ...
    public double getNineth() {
        return nineth;
    }

    public void setNineth(double nineth) {
        this.nineth = nineth;
    }
