package com.lingda.gamble.mail;
...
public class SimpleMailSender {
    ...
    public static void send(String emailAddress, String subject, String htmlContent) {
        ...
        mailInfo.setUserName("darlingtld@163.com");
        mailInfo.setPassword("Darling@1988");//您的邮箱密码
        mailInfo.setFromAddress("darlingtld@163.com");
